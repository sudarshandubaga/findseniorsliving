<section class="py-20 bg-gray-50/50">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="#"
                class="text-primary font-bold text-sm uppercase tracking-wider flex items-center hover:underline group">
                Find A Lawyer
                ...
                <div
                    ...
                    <div class="px-8 pb-8 flex flex-col flex-grow text-center">
                        ...
                        <div class="mt-auto pt-6 border-t border-gray-100 flex flex-col gap-3">
                            <a href="#"
                                class="bg-primary text-white w-full py-3 rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-opacity-90 transition-all shadow-lg shadow-primary/20">
                                Contact Lawyer
                            </a>
